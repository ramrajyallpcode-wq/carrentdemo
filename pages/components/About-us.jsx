  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://demo@gmail.com.com/components/About-us"
        />
      </Head>
              ...
              <div className="space-y-8 order-1 lg:order-2">
                <div className="space-y-4">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                    Your{" "}
                    <span className="text-yellow-500">Trusted Cab Service</span>{" "}
                    Partner in India
                  </h2>
                ...
                <div className="space-y-5 text-gray-700">
                  <p className="text-base sm:text-lg md:text-xl">
                    Welcome to our Cab Services, headquartered in{" "}
                    <strong>city</strong>, where we’ve spent the last decade
                    redefining city and outstation travel with dependable
                    chauffeurs and immaculate vehicles.
                  </p>
                  <p className="text-base sm:text-lg">
                    With <strong>10+ years of experience</strong>, we deliver
                    hassle-free rentals, premium comfort, and courteous drivers
                    who know city’s lanes as well as India’s highways.
                  </p>
                  <p className="text-base sm:text-lg">
                    Our fleet spans compact sedans to spacious SUVs, all driven
                    by professionals who undergo regular training, safety
                    inspections, and hospitality refreshers to ensure every
