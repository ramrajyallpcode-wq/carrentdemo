...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      alt: "city city landmarks and attractions",
      description:
        "Explore the vibrant city of city with our local taxi services. From the bustling Sarafa Bazaar to the magnificent Lal Bagh Palace, discover the commercial capital of Madhya Pradesh. Our local drivers know every corner of the city, ensuring you experience the best of city's culture, cuisine, and attractions comfortably and efficiently.",
    },
    {
      id: 6,
      title: "city To Mandleshwar",
                ...
                <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 h-full flex flex-col">
                  ...
                  <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <a
                        href="https://wa.me/?text=Hi! I'm interested in booking a cab service. Could you please provide more details?"
                        target="_blank"
