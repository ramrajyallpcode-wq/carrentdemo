        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <article className="order-2 lg:order-1 mt-8 lg:mt-0">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
              Your Trusted Car Service Partner in India
            </h1>
            <main className="space-y-3 sm:space-y-4 text-gray-600 text-sm sm:text-base">
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure
                deserunt odio sed praesentium obcaecati nulla? Consequatur
                facilis sit dicta dignissimos vero repellat libero!
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Doloremque laborum harum aperiam laboriosam voluptate, placeat
                explicabo quasi voluptatem impedit dolorem inventore doloribus
                voluptates.
              </p>
            </main>
